...
`Live editing` &middot; `Tracked changes` &middot; `Per-action undo` &middot; `195 tools` &middot; `Cross-platform`
...
- **195 tools** — The most comprehensive Word MCP server available.
...
**195 tools** across two modes — see the [complete tool reference](TOOLS.md) for details.

| Category | Count |
|----------|-------|
| Cross-platform (python-docx) | 121 |
| Windows Live (COM automation) | 74 |
| macOS Live (JXA automation) | 60 (subset of the 74 live tools) |
