...
def register_tools():
    """Register all tools with the MCP server from the declarative registry."""
...
def run_server():
    ...
    # Register all tools
    from word_document_server.utils.path_validation import configure as configure_path_validation
    configure_path_validation(os.getenv("MCP_ALLOWED_DIRS"))
    register_tools()
