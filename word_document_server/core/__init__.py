...
__all__ = [
    "ensure_heading_style", "ensure_table_style", "create_style",
    "add_protection_info", "verify_document_protection", "is_section_editable",
    "create_signature_info", "verify_signature",
    "add_footnote", "add_endnote", "convert_footnotes_to_endnotes",
    "find_footnote_references", "get_format_symbols", "customize_footnote_formatting",
